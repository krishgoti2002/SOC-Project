<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="EditJob.aspx.cs" Inherits="ClientCandidate.WebForms.EditJob" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            <td colspan="3">
                <asp:Button ID="button_register" CssClass="btn btn-primary" runat="server" Text="Update" OnClick="button_register_Click"/>
